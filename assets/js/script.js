...
function handleChosenLetter(chosenLetter) {
    ...
    for (var i = 0; i < randomWord.length; i++) {
        ...
        if (chosenLetter.toLowerCase() === randomWord[i]) {
            guessed[i] = chosenLetter.toLowerCase();
            guessBlanks[i].innerHTML = chosenLetter.toLowerCase();
        ...
        guessed.push(chosenLetter.toLowerCase());
    }
